...
<tr><td class="lefttd"><a href="addcity.php">Add Area</a></td></tr>
<?php if($_SESSION["username"]=="kee")
{?>
<tr><td class="lefttd"><a href="updatecity.php">Update Area</a></td></tr>
<tr><td class="lefttd"><a href="deletecity.php">Delete Area</a></td></tr>

<?php }?>

<tr><td class="lefttd"><a href="addstate.php">Add City</a></td></tr>
<?php if($_SESSION["username"]=="kee")
{?>

<tr><td class="lefttd"><a href="updatestate.php">Update City</a></td></tr>
<tr><td class="lefttd"><a href="deletestate.php">Delete City</a></td></tr>

<?php }?>

<tr><td class="lefttd"><a href="addcamp.php">Add Food Details</a></td></tr>
<?php if($_SESSION["usertype"]=="Admin")
{?>
