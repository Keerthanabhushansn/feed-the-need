...
<tr><td colspan="2" align="center" class="toptd">Add food </td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><td class="lefttd">food Title</td><td><input type="text" name="t3" value="<?php if(isset($_POST["show"])){echo $_POST["t3"];} ?>" required="required" pattern="[a-zA-Z.1 _]{5,35}" title="please enter only character or numbers between 5 to 35 for camp title"/></td></tr>
